...
int do_printf(std::string_view format, std::ostream& outs, const std::locale& loc, va_list va);
...
auto do_printf(std::string_view format, std::ostream& outs, size_t max, va_list args)->std::pair<int, int>;
